...
for cv=1:n_test
    ...
    parfor alph_i = 1: length(alph)
        [tmp_POSITION(alph_i,:)]=Method_Gaussian(interaction, k_fold,Random_order(:,cv),alph( alph_i ));
...
save ./Results/Gaussian_results.mat POSITION Auc_avg AUC_std Random_order fpr tpr overallauc alph_list
toc
